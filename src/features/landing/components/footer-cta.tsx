...
export default function FooterCta() {
  ...
  return (
    <section className="w-full h-130 relative z-20 rounded-t-[60px] bg-linear-to-tr from-charcoal to-charcoal/85">
      <div className="min-h-130 max-w-7xl grid lg:grid-cols-2 items-center gap-10 mx-auto px-6 pb-32 lg:px-8 lg:pb-40 pt-16  relative z-10">
        ...
        >
          <Image
            ...
            width={650}
            height={900}
            className="absolute left-1/2 top-1/2 w-100 max-w-none -translate-x-1/2 translate-y-[-33%] rotate-[5deg] object-contain"
          />
        </motion.div>
      </div>
    </section>
